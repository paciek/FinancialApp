                                    ...
                                    <tr>
                                        <td>
                                            <form method="POST" action="{{ route('categories.update', $category) }}" class="d-flex gap-2">
                                                ...
                                                <input
                                                    ...
                                                    maxlength="100"
                                                >
                                                <select name="type" class="form-select" style="max-width: 10rem;" required>
                                                    <option value="expense" @selected($category->type === 'expense')>Wydatek</option>
                                                    <option value="income" @selected($category->type === 'income')>Przychod</option>
                                                </select>
                                        ...
                                        <td>
                                            <span class="badge {{ $category->type === 'income' ? 'text-bg-success' : 'text-bg-danger' }}">
                                                {{ $category->type === 'income' ? 'Przychod' : 'Wydatek' }}
                                            </span>
                                        </td>
                                        <td class="text-end">
