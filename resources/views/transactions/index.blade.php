...
<body class="bg-light">
    <div class="container py-5">
        ...
        @php
            ...
            $dateIcon = $sort === 'transaction_date'
                ? ($direction === 'asc' ? 'fa-sort-up' : 'fa-sort-down')
                : 'fa-sort';
            $amountIcon = $sort === 'amount'
                ? ($direction === 'asc' ? 'fa-sort-up' : 'fa-sort-down')
                : 'fa-sort';
        @endphp
                    ...
                    <table class="table table-striped align-middle mb-0">
                        <thead>
                            <tr>
                                <th>
                                    <a
                                        href="{{ route('transactions.index', array_merge(request()->all(), ['sort' => 'transaction_date', 'direction' => $nextDateDirection])) }}"
                                        class="text-decoration-none {{ $sort === 'transaction_date' ? 'text-primary' : 'text-dark' }}"
                                    >
                                ...
                                <th>
                                    <a
                                        href="{{ route('transactions.index', array_merge(request()->all(), ['sort' => 'amount', 'direction' => $nextAmountDirection])) }}"
                                        class="text-decoration-none {{ $sort === 'amount' ? 'text-primary' : 'text-dark' }}"
                                    >
